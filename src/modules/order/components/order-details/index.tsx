...
const OrderDetails = ({ order, showStatus }: OrderDetailsProps) => {
  ...
  return (
    <div className="p-10 border-b border.gray-200">
      <span className="text-muted-foreground text-small-regular uppercase">
      ...
      <div className="flex items-center text-muted-foreground text-small-regular gap-x-4 mt-4">
