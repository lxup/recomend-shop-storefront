  ...
  return (
    <div className="bg-background">
      <div className="text-xl-semi flex items-center gap-x-4 px-8 pb-6 pt-8">
        <div className="bg-accent-1 text-background w-8 h-8 rounded-full flex justify-center items-center text-sm">
          1
        </div>
      ...
      {isEdit ? (
          ...
          {!checked && (
            <div>
              <div className="text-xl-semi flex items-center gap-x-4 pb-6 pt-8">
                <div className="bg-accent-1 text-background w-8 h-8 rounded-full flex justify-center items-center font-mono text-sm">
                  2
                </div>
        ...
        <div>
          ...
          {!checked && (
            <div>
              <div className="text-xl-semi flex items-center gap-x-4 px-8 pb-6 pt-8">
                <div className="bg-accent-1 w-8 h-8 rounded-full text-background flex justify-center items-center font-mono text-sm">
                  2
                </div>
                <h2>Billing address</h2>
              </div>
              <div className="bg-muted px-8 py-6 text-small-regular">
